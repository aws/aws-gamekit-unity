...
namespace AWS.GameKit.Runtime.Features.GameKitAchievements
{
    ...
    /// </summary>
    public class Achievements : GameKitFeatureBase<AchievementsWrapper>, IAchievementsProvider
    {
        ...
        /// </summary>
        /// <returns>An instance of the Achievements feature that can be used to call Achievement related methods.</returns>
        public static Achievements Get()
        {
            return GameKitFeature<Achievements>.Get();
        }
